 ...
 */
public class MapActivity extends AbsActivity implements TabbView.OnTabClickedListener {
    public static final int MY_ACTIVITY_ID = 2;
        ...
        if (id != MY_ACTIVITY_ID) {
            ...
            switch (id) {
                case RoutesActivity.MY_ACTIVITY_ID:
                    i = new Intent(MapActivity.this, RoutesActivity.class);
                    break;
                case ARViewActivity.MY_ACTIVITY_ID:
                    i = new Intent(MapActivity.this, ARViewActivity.class);
                    break;
                case ScanActivity.MY_ACTIVITY_ID:
                    i = new Intent(MapActivity.this, ScanActivity.class);
                    break;
            }
            if (i != null) {
                startActivity(i);
