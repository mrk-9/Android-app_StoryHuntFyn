...
public class CurlRenderer implements GLSurfaceView.Renderer {
    ...
    private void translateMargins() {
        mMargins.left = mMargins.left / mViewRect.width();
        mMargins.right = mMargins.right / mViewRect.width();
        mMargins.top = mMargins.top / mViewRect.height();
        mMargins.bottom = mMargins.bottom / mViewRect.height();
    }
	/**
